...
main = do
    ...
    whileM_ (fmap (< 105000000) (getFileSize file1)) (appendFile file1 "aaaaaaaaaabbbbbbbbbbaaaaaaaaabbbbbbbbbbaaaaaaaaaa\n")
    putStrLn "file 1 done"
    writeFile file2 "250MB. This is a file that has a size of 250MB. \n"
    whileM_ (fmap (< 265000000) (getFileSize file2)) (appendFile file2 "aaaaaaaaaabbbbbbbbbbaaaaaaaaabbbbbbbbbbaaaaaaaaaa\n")
